...
blob = bucket.blob('sen2amazontest.tif')

# Downloads the file to your local machine
###blob.download_to_filename('/Users/saraswathyamjith/loggingdetector/sen2amazontest.tif')

# Gets the file you want to download
blob2 = bucket.blob('sen2amazontest-jan.tif')

# Downloads the file to your local machine
###blob2.download_to_filename('/Users/saraswathyamjith/loggingdetector/sen2amazontest-jan.tif')

### extracting the lat/long coordinates for pixels with deforestation
sentinel2dec = rasterio.open( bucket.blob('sen2amazontest.tif'))
sentinel2jan = rasterio.open( bucket.blob('sen2amazontest-jan.tif'))
