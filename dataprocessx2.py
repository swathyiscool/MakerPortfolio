...
Original file is located at
    https://colab.research.google.com/drive/1W4Cz2CRcSA1B2dlNZRrKlvLlXkIp-DqT
"""
...
print(sentinel1dec.res)
print(sentinel2jan.res)
...
for b in range (0, len(datalong)):
    ...
    if (sen1drow>=1 and sen1dcol>=1):
      sen1dec3x3 = sen1decband[:, sen1drow-1:sen1drow+2, sen1dcol -1:sen1dcol +2]
      sen1jan3x3 = sen1janband[:, sen1jrow-1:sen1jrow+2, sen1jcol -1:sen1jcol +2]

      sen2dec3x3 = sen2decband[:, sen2drow-1:sen2drow+2, sen2dcol -1:sen2dcol +2]
      sen2jan3x3 = sen2janband[:, sen2jrow-1:sen2jrow+2, sen2jcol -1:sen2jcol +2]
      ...
      for e in range (0, sen1dec3x3.shape[0]):
          ...
          for c in range (0, 3):
              for d in range (0, 3):
                   avgvalsen1d += sen1dec3x3[e][c][d]
                   avgvalsen1j += sen1jan3x3[e][c][d]

          rowsen1d.append(avgvalsen1d / 9)
          rowsen1j.append(avgvalsen1j / 9)


      for e in range (0, sen2dec3x3.shape[0]):
          ...
          rowsen2d.append(avgvalsen2d / 9)
          rowsen2j.append(avgvalsen2j / 9)

      csvlistsen1dec.append(rowsen1d)
      csvlistsen1jan.append(rowsen1j)
      csvlistsen2dec.append(rowsen2d)
      csvlistsen2jan.append(rowsen2j)
...
for b in range (0, len(datalong2)):
    ...
    if (sen1drow>=1 and sen1dcol>=1):
      sen1dec3x3 = sen1decband2[:, sen1drow-1:sen1drow+2, sen1dcol -1:sen1dcol +2]
      sen1jan3x3 = sen1janband2[:, sen1jrow-1:sen1jrow+2, sen1jcol -1:sen1jcol +2]

      sen2dec3x3 = sen2decband2[:, sen2drow-1:sen2drow+2, sen2dcol -1:sen2dcol +2]
      sen2jan3x3 = sen2janband2[:, sen2jrow-1:sen2jrow+2, sen2jcol -1:sen2jcol +2]
